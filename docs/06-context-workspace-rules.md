...
### 2.3 Context 七层业务维度（已实现）

`context/` 目录下预设了产品经理工作的 7 个核心维度文件夹：
...
**与项目级目录的关系**：
- 七层维度文件夹：跨项目的通用知识（如公司战略、通用约束）
- `{project_id}/` 目录：特定项目的知识（如某产品的术语表）

### 2.4 子目录创建规则

**延迟创建原则**：除了预设的 7 个维度文件夹外，只有当目录积累 **7+ 个相似主题的文件** 时，才创建新的子目录
